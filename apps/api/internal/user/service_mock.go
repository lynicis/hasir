...
//
//	mockgen -package=user -destination=internal/user/service_mock.go -source=internal/user/service.go
//
...
func (m *MockEmailService) SendForgotPassword(to, resetToken string) error {
	m.ctrl.T.Helper()
...
func (mr *MockEmailServiceMockRecorder) SendForgotPassword(to, resetToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendForgotPassword", reflect.TypeOf((*MockEmailService)(nil).SendForgotPassword), to, resetToken)
}
