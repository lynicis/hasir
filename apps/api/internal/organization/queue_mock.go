...
// Source: internal/organization/queue.go
//
// Generated by this command:
//
//	mockgen -package=organization -destination=internal/organization/queue_mock.go -source=internal/organization/queue.go
//
