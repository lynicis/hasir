...
import { ScrollArea } from "@hasir/ui/components/scroll-area"
...
export { CollapseButton, File, Folder, Tree, Tree as TreeWithLazyLoad, type TreeViewElement, type TreeViewElement as ExtendedTreeViewElement }
